...
import { Code, Search, Palette, Printer, ExternalLink, TrendingUp } from 'lucide-react';
...
const ServicesSection: React.FC<Props> = ({ t, lang = 'en' }) => {
  ...
  const menuItems = [
    ...
    { label: t('nav.gdpr'), to: '/gdpr' },
  ];

  // Compute initial caret position before typing starts
  useEffect(() => {
  ...
  // Observe scroll to update right-side dot navigation active state
  useEffect(() => {
    const onScroll = () => {
    ...
    <div className="relative min-h-screen text-white">
      ...
      <nav className="fixed top-0 w-full bg-gray-900/90 backdrop-blur-sm border-b-2 border-green-400 z-50">
        <div className="container mx-auto px-4">
          ...
          {/* Mobile dropdown */}
          {isMenuOpen && (
            <div className="md:hidden absolute top-16 left-0 w-full bg-gray-900 border-b-2 border-green-400">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      [
                        ...
                        'text-green-400 hover:text-white hover:bg-green-400/10 border-l-4 border-transparent',
                        isActive ? 'text-white border-green-400' : '',
                      ].join(' ')
                    }
                  >
                    {item.label}
      ...
      {/* WEB (full viewport, transparent background) */}
      <section id="web" className="min-h-screen flex items-center">
        <div className="container mx-auto px-4">
      ...
      {/* SEO (full viewport, transparent background) */}
      <section id="seo" className="min-h-screen flex items-center">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
      ...
      {/* BRANDING (full viewport, transparent background) */}
      <section id="branding" className="min-h-screen flex items-center">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
      ...
      {/* PRINT (full viewport, transparent background) */}
      <section id="print" className="min-h-screen flex items-center">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
      ...
      {/* RIGHT DOT-NAV (section snap helper) */}
      ...
      {/* FOOTER (own background retained) */}
